class screen_title
{
  ...
  screen_title()
  {
    title_img_bg = loadImage("data/title_grey_noav.png");
    title_img_city = loadImage("data/city.png");
    spotlight_img = loadImage("data/spotlight.png");
    ...
    pressXtoStart = new basic_image(loadImage("data/pressXtoStart.png"),64,115);
  }
