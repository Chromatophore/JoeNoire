class scoremaster
{
	...
	scoremaster()
	{
		...
		good = new basic_image(indi_loadImage("data/MIT/UI/smile.png"),0,0);
		ehhh = new basic_image(indi_loadImage("data/MIT/UI/ehhh.png"),0,0);
		bad	= new basic_image(indi_loadImage("data/MIT/UI/sad.png"),0,0);
	}
